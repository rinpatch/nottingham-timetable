...
if timetable_url and not parsed_url.netloc == "timetablingunmc.nottingham.ac.uk:8016":
    st.error("Please enter a valid URL from timetablingunmc.nottingham.ac.uk")
